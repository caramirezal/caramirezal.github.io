...
```{r, quizz2, include=FALSE}
umi.counts <- apply(pbmc.mtx, 1, sum)
sort(umi.counts, decreasing = TRUE) %>% head
```
...
```{r, quizz3, include=FALSE}
1-sum(pbmc.mtx[pbmc.mtx>0])/prod(dim(pbmc.mtx))
```
