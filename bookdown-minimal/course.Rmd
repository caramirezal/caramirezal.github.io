...
As can be seen from the output of the function `dim(pbmc.mtx)` the matrix contains 13,714 rows (genes) and `r ncol(pbmc.mtx)` columns (cells). 
...
<!--chapter:end:02-Quality_control.Rmd-->
...
<!--chapter:end:03-Feature_selection.Rmd-->
...
<!--chapter:end:04-Normalization_and_Dimensional_Reduction.Rmd-->
...
<!--chapter:end:05-Cluster_visualization.Rmd-->
...
<!--chapter:end:06-Differential_Expression.Rmd-->
...
<!--chapter:end:07-Profiling_cells.Rmd-->
